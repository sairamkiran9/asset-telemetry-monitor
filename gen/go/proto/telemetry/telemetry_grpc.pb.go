...
const (
	...
	TelemetryService_GetTelemetryData_FullMethodName = "/telemetry.TelemetryService/GetTelemetryData"
)
...
type TelemetryServiceClient interface {
	SubmitTelemetry(ctx context.Context, in *SubmitTelemetryRequest, opts ...grpc.CallOption) (*SubmitTelemetryResponse, error)
...
func (c *telemetryServiceClient) SubmitTelemetry(ctx context.Context, in *SubmitTelemetryRequest, opts ...grpc.CallOption) (*SubmitTelemetryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SubmitTelemetryResponse)
	err := c.cc.Invoke(ctx, TelemetryService_SubmitTelemetry_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *telemetryServiceClient) GetTelemetryData(ctx context.Context, in *GetTelemetryDataRequest, opts ...grpc.CallOption) (*GetTelemetryDataResponse, error) {
	...
	err := c.cc.Invoke(ctx, TelemetryService_GetTelemetryData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TelemetryServiceServer interface {
	SubmitTelemetry(context.Context, *SubmitTelemetryRequest) (*SubmitTelemetryResponse, error)
...
func (UnimplementedTelemetryServiceServer) SubmitTelemetry(context.Context, *SubmitTelemetryRequest) (*SubmitTelemetryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SubmitTelemetry not implemented")
}
func (UnimplementedTelemetryServiceServer) GetTelemetryData(context.Context, *GetTelemetryDataRequest) (*GetTelemetryDataResponse, error) {
...
func _TelemetryService_SubmitTelemetry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SubmitTelemetryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TelemetryServiceServer).SubmitTelemetry(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TelemetryService_SubmitTelemetry_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TelemetryServiceServer).SubmitTelemetry(ctx, req.(*SubmitTelemetryRequest))
	}
...
func _TelemetryService_GetTelemetryData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TelemetryService_GetTelemetryData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
